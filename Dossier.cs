    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (isWorking)
            {
                ...
                {
                    case "1":
                        CreatingDossier(ref familyArray, ref nameArray, ref postArray, ref ID, ref idArray);
                        break;
                    case "2":
                        ShowAllDossier(familyArray, nameArray, postArray, idArray);
                        break;
                    case "3":
            ...
            static void ShowAllDossier(string[] familyArray, string[] nameArray, string[] postsArray, int[] idArray)
            {
                Console.Clear();
                Console.WriteLine($" ID - Фамилия -  Имя - Отчество -  Должность ");
            ...
            static void CreatingDossier(ref string[] familyArray, ref string[] nameArray, ref string[] postArray, ref int ID, ref int[] idArray)
            {
